...
var _this = this;
var AllAds = function () { return __awaiter(_this, void 0, void 0, function () {
    var data, endpoint, fetchRequest, fetchAds, response, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                endpoint = 'http://localhost:3300/api/v1/property/';
                fetchRequest = {
                    method: 'GET',
                    headers: {
...
//# sourceMappingURL=allProperty.js.map