...
describe('/property', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            _context.next = 18;
            return request.post('/api/v1/property').set('Authorization', firstUserToken).attach('image_url', 'src/test/img2.png').field(propertyBody);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return request.post('/api/v1/property').set('Authorization', secondUserToken).attach('image_url', 'src/test/img2.png').field(body);
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return request.post('/api/v1/property').set('Authorization', 'hjjfjriu').attach('image_url', 'src/test/img2.png').field(body);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 3;
                return request.post('/api/v1/property').set('Authorization', firstUserToken).attach('image_url', 'src/test/img2.png').field(body);
  ...
  describe('PATCH ROUTE WITH ID', function () {
    describe('PATCH PROPERTY ADVERT FOR PRICE ONLY SUCCESS', function () {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return request.patch("/api/v1/property/".concat(propertyId)).set('Authorization', firstUserToken).attach('image_url', 'src/test/img1.jpg').field(body);
    ...
    describe('PATCH PROPERTY ADVERT FOR EVERY OTHER BODY PROPERTY', function () {
      it('should have a status of 200',
      /*#__PURE__*/
      (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    describe('PROPERTY ADVERT NO PRICE', function () {
      it('should have a status of 403',
      /*#__PURE__*/
      (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                _context9.next = 3;
                return request.patch("/api/v1/property/".concat(propertyId)).set('Authorization', firstUserToken).attach('image_url', 'src/test/img2.png').field(body);
