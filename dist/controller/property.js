      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            values = [(0, _helper.generateId)() + '1', response.rows.email, 'available', state, city, type, price, property_name, property_description, contact_person_number, address, proof, note, req.Image_url, (0, _moment["default"])(new Date()), (0, _moment["default"])(new Date())];
            _context.prev = 7;
            _context.next = 10;
