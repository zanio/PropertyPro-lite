...
propertyrouter.patch('/property/:id', _auth.idCheck, _auth.authorization, _jsonweb.jwtVerify, _multer.multerUploads, _inputfield.checkPropertyEmpty, _cloudinary.cloudinaryHandler, _property.updateProperty);
